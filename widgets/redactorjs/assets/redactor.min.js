...
(function (b)
{
    ...
    }, getPath                : function ()
    {
        ...
        b("script").each(b.proxy(function (c, d)
        {
            if (d.src)
            {
                var e = new RegExp(/\/redactor\.min\.js|\/redactor\.js/);
                if (d.src.match(e))
                {
    ...
    {
        var d = parseInt(this.height.replace("px", ""));
        var c = this.getEditorHeight();
        if (c <= d)
        {
            c = d + 40
        } else
    ...
    {
        return this.$editor.height() + this.normalize(this.$editor.css("margin-top")) + this.normalize(this.$editor.css("margin-bottom")) + this.normalize(this.$editor.css("padding-top")) + this.normalize(this.$editor.css("padding-bottom"))
    ...
    }, formating              : function (j)
    {
        ...
        j = j.replace(/^[\s\n]*/, "");
        j = j.replace(/[\s\n]*$/, "");
        var e = ["<pre></pre>", "<blockquote></blockquote>", "<em></em>", "<b></b>", "<ul></ul>", "<ol></ol>", "<li></li>", "<table></table>", "<tr></tr>", "<span><span>", "<span>&nbsp;<span>", "<p> </p>", "<p></p>", "<p>&nbsp;</p>", "<p><br></p>", "<div></div>"];
    ...
    {
        this.modalInit(RLANG.table, this.opts.path + "/plugins/table.html", 230, b.proxy(function ()
        {
    ...
    }, showImage              : function ()
    {
        ...
        var c = b.proxy(function ()
        {
            ...
            {
                b.getJSON(this.opts.imageGetJson, b.proxy(function (d)
                {
                    b.each(d, b.proxy(function (f, g)
                    {
                        var e = b('<img src="' + g.thumb + '" rel="' + g.image + '" />');
                        b("#redactor_image_box").append(e);
                        b(e).click(b.proxy(this.imageSetThumb, this))
                    }, this))
                }, this))
            } else
            {
                b("#redactor_tabs li").eq(1).remove()
            }
    ...
    }, modalInit              : function (g, d, f, e, c)
    {
        ...
        b.ajax({dataType: "html", type: "get", url: d, success: b.proxy(function (i)
        {
            ...
            b("#redactor_modal").css({width: f + "px", height: "auto", marginTop: "-" + (h + 10) / 2 + "px", marginLeft: "-" + (f + 100) / 2 + "px"}).fadeIn("fast");
            if (c === true)
            {
